...
<head>
    ...
    <title>INSPINIA | Helper css classes</title>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level collapse">
                        ...
                        <li class="active"><a href="helper_classes">Helper css classes</a></li>
                        ...
                        <div class="ibox-content">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td><img src="img/a4.jpg" class="rounded-circle img-md"/> </td>
                                </tr>
                                <tr>
                                    <td><code>.rounded</code></td>
                                    <td><img src="img/a4.jpg" class="rounded img-md"/></td>
                                </tr>
                                <tr>
