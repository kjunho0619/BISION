        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="active"><a href="tree_view">Tree view</a></li>
                        ...
                        <ul>
                            <li class="jstree-open">Admin theme
                                <ul>
                                    ...
                                    <li>email-templates
                                        <ul>
                                            <li data-jstree='"type":"html"}'>action</li>
                                            <li data-jstree='"type":"html"}'>alert</li>
                                            <li data-jstree='"type":"html"}'>billing</li>
                                        </ul>
                                    </li>
                                    <li>fonts
                                        <ul>
                                    ...
                                    <li data-jstree='"type":"html"}'> affix</li>
                                    <li data-jstree='"type":"html"}'> dashboard</li>
                                    <li data-jstree='"type":"html"}'> buttons</li>
                                    <li data-jstree='"type":"html"}'> calendar</li>
                                    <li data-jstree='"type":"html"}'> contacts</li>
                                    <li data-jstree='"type":"html"}'> css_animation</li>
                                    <li  class="text-navy" data-jstree='"type":"html"}'> flot_chart</li>
                                    <li  class="text-navy" data-jstree='"type":"html"}'> google_maps</li>
                                    <li data-jstree='"type":"html"}'> icons</li>
                                    <li data-jstree='"type":"html"}'> invoice</li>
                                    <li data-jstree='"type":"html"}'> login</li>
                                    <li data-jstree='"type":"html"}'> mailbox</li>
                                    <li data-jstree='"type":"html"}'> profile</li>
                                    <li  class="text-navy" data-jstree='"type":"html"}'> register</li>
                                    <li data-jstree='"type":"html"}'> timeline</li>
                                    <li data-jstree='"type":"html"}'> video</li>
                ...
                'Empty Folder',
                {
                    ...
                    'children': [
                        ...
                        },
                        {
                            ...
                            'children': [
                                {
                                    'text': 'layout', 'icon': 'none'
                                },
                                {
                                    'text': 'navigation', 'icon': 'none'
                                },
                                {
                                    'text': 'navbar', 'icon': 'none'
                                },
                                {
                                    'text': 'footer', 'icon': 'none'
                                },
                                {
                                    'text': 'sidebar', 'icon': 'none'
                                }
                            ],
                            'state': {
                                'opened': true
