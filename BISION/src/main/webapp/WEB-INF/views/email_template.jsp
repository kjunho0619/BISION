            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><a href="email_template">Email templates</a></li>
                    </ul>
                </li>
                <li>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <h4>Basic action email</h4>
                                        <a href="email_templates/action" target="_blank">
                                    <img src="img/email_1.jpg" class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <h4>Email alert </h4>
                                        <a href="email_templates/alert" target="_blank">
                                    <img src="img/email_2.jpg" class="img-fluid" alt="">
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <h4>Billing email</h4>
                                        <a href="email_templates/billing" target="_blank">
